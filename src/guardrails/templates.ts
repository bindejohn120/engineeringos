...
export const GUARDRAIL_TEMPLATES: GuardrailTemplate[] = [
  ...
  },
  {
    ...
    name: 'React: Key prop required in lists',
    category: 'correctness',
    applicableFrameworks: ['react', 'next', 'remix'],
    applicableLanguages: ['typescript', 'javascript'],
    severity: 'warning',
  ...
  },
  {
    ...
    name: 'React: No direct state updates in useEffect without deps',
    category: 'correctness',
    applicableFrameworks: ['react', 'next', 'remix'],
    applicableLanguages: ['typescript', 'javascript'],
    severity: 'warning',
  ...
  },
  {
    ...
    name: 'React: Avoid inline styles for complex components',
    category: 'performance',
    applicableFrameworks: ['react', 'next', 'remix'],
    applicableLanguages: ['typescript', 'javascript'],
    severity: 'advisory',
  ...
  // ─── Mobile: React Native ────────────────────────────────────────────────
  {
    ...
    applicableRuntime: ['react-native'],
    applicableLanguages: ['typescript', 'javascript'],
    severity: 'warning',
  ...
  // ─── Mobile: Flutter ─────────────────────────────────────────────────────
  {
    ...
    applicableRuntime: ['flutter'],
    applicableLanguages: ['dart'],
    severity: 'blocking',
